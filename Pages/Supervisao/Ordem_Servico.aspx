<%@ page language="C#" validaterequest="false" enableeventvalidation="True" autoeventwireup="true" inherits="gcmenterprise.DataPages.Ordem_Servico, App_Web_z5xkuqoz" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<link rel="stylesheet" href="../../Styles/Ordem_Servico.css?sv=1.127.2017" type="text/css" media="screen" title="no title" charset="utf-8" />
...
<body onload="InitializeClient();" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	...
	<script type="text/javascript" src="../../JS/Ordem_Servico_USER.js?sv=1.127.2017" language="JavaScript"></script>
			...
			<telerik:RadAjaxPanel id="MainAjaxPanel" runat="server" class="c_MainAjaxPanel" ClientEvents-OnRequestStart="OnRequestStart" ClientEvents-OnResponseEnd="OnResponseEnd" LoadingPanelID="___Form1_AjaxLoading">
				<div id="__MainDiv" class="c_MainDiv" FitToContent="True" MarginToContent="0">
					...
					<telerik:RadTextBox id="RadTextBox2" runat="server" AutoPostBack="False" data-validation-engine="validate[funcCall[RadTextBox2_Validation]]"
						data-validation-message="DESCRIÇÃO DA OS não pode ser vazio!" EnableSingleInputRendering="True" ForeColor="#000000" MaxLength="100"
						onkeydown="onTextChanged" ReadOnly="False" RenderMode="Classic" TabIndex="5" TextMode="SingleLine" WrapperCssClass="c_RadTextBox2_wrapper" />
					...
					<telerik:RadTimePicker id="DatePicker2" runat="server" ClientEvents-OnDateSelected="setDatePickerFocus" DateInput-DateFormat="HH:mm"
						...
						MinDate="01/01/1900" PopupDirection="BottomRight" ReadOnly="False" RenderMode="Classic" ShowAnimation-Duration="300" ShowAnimation-Type="Fade"
						TabIndex="2" TimeView-EndTime="23:00" TimeView-StartTime="00:00" Width="129px">
					</telerik:RadTimePicker>
					<telerik:RadLabel id="Label17" runat="server" Text="<%$ Resources: Label17 %>" />
					<telerik:RadComboBox id="ComboBoxvIATURA" runat="server" AllowCustomText="False" AutoPostBack="False" CollapseAnimation-Duration="300"
						CollapseAnimation-Type="None" EnableEmbeddedSkins="True" EnableLoadOnDemand="True" EnableVirtualScrolling="True" ExpandAnimation-Duration="300"
						ExpandAnimation-Type="None" LoadingMessage="<%$ Resources: ComboBoxvIATURA %>" MarkFirstMatch="true" MaxHeight="100"
						...
						OnItemsRequested="___ComboBoxvIATURA_OnItemsRequested" RenderMode="Classic" TabIndex="6" />
	...
	<script type="text/javascript">
		...
		function ID_OS() { return document.getElementById("RadTextBox1").value; }
		function OS_DATA() { return document.getElementById("DatePicker1").value; }
		function OS_STATUS() { return $find("<%= ComboBox1.ClientID %>").get_value(); }
		function OS_PRIORIDADE() { return $find("<%= ComboBox2.ClientID %>").get_value(); }
		function OS_DESCRICAO() { return document.getElementById("RadTextBox2").value; }
		function OS_HORA() { return document.getElementById("DatePicker2").value; }
		function OS_VIATURA() { return $find("<%= ComboBoxvIATURA.ClientID %>").get_value(); }
		...
		function LoadEditAuto() {
				...
				$j("#ComboBoxvIATURA").bind("change", InitiateEditAuto);
