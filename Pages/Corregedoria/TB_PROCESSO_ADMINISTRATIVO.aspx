<%@ page language="C#" validaterequest="false" enableeventvalidation="True" autoeventwireup="true" inherits="gcmenterprise.DataPages.TB_PROCESSO_ADMINISTRATIVO, App_Web_kni1tjkc" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<link rel="stylesheet" href="../../Styles/TB_PROCESSO_ADMINISTRATIVO.css?sv=1.127.2017" type="text/css" media="screen" title="no title" charset="utf-8" />
...
<body onload="InitializeClient();" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	...
	<script type="text/javascript" src="../../JS/TB_PROCESSO_ADMINISTRATIVO_USER.js?sv=1.127.2017" language="JavaScript"></script>
			...
			<telerik:RadAjaxPanel id="MainAjaxPanel" runat="server" class="c_MainAjaxPanel" ClientEvents-OnRequestStart="OnRequestStart" ClientEvents-OnResponseEnd="OnResponseEnd" LoadingPanelID="___Form1_AjaxLoading">
				<div id="__MainDiv" class="c_MainDiv" FitToContent="True" MarginToContent="0">
					...
					<telerik:RadTextBox id="RadTextBox2" runat="server" AutoPostBack="False" data-validation-engine="validate[funcCall[RadTextBox2_Validation]]"
						data-validation-message="N° PROCESSO não pode ser vazio!" EnableSingleInputRendering="True" ForeColor="#000000" MaxLength="15"
					...
					<telerik:RadTextBox id="RadTextBox3" runat="server" AutoPostBack="False" EnableSingleInputRendering="True" ForeColor="#000000" MaxLength="4"
					...
					<telerik:RadComboBox id="ComboBox1" runat="server" AllowCustomText="False" AutoPostBack="False" CollapseAnimation-Duration="300"
						...
						OnItemsRequested="___ComboBox1_OnItemsRequested" RenderMode="Classic" TabIndex="4" />
					<telerik:RadLabel id="Label9" runat="server" Text="<%$ Resources: Label9 %>" />
					<telerik:RadTextBox id="RadTextBox4" runat="server" AutoPostBack="False" EnableSingleInputRendering="True" ForeColor="#000000" MaxLength="50"
					...
					<gas:GEditor id="GEditor1" runat="server" EnableEmbeddedSkins="True" TabIndex="7" ViewMode="Design" />
						...
						<MasterTableView  AllowCustomPaging="true" CommandItemDisplay="Top" DataKeyNames="ID" EditMode="InPlace" OnItemCreated="Grid1_ItemCreated" OnUpdateCommand="Grid_UpdateCommand">
							<Columns>
								...
								<telerik:GridTemplateColumn UniqueName="GridColumn3" runat="server" AllowFiltering="True" ConvertEmptyStringToNull="False" DataField="ID_GCM"
									Exportable="True" FilterControlWidth="452" ForceExtractValue="Always" GroupByExpression="ID_GCM ID_GCM Group By ID_GCM"
									HeaderStyle-Width="487" HeaderText="<%$ Resources: GridColumn3 %>" ItemStyle-Width="480" ReadOnly="False" SortExpression="ID_GCM"
									Visible="True">
									<EditItemTemplate>
	...
	<script type="text/javascript">
		...
		function ID_PA() { return document.getElementById("RadTextBox1").value; }
		function NUM_PROCESSO() { return document.getElementById("RadTextBox2").value; }
		function PA_ANO() { return document.getElementById("RadTextBox3").value; }
		function PA_DATA_INST() { return document.getElementById("DatePicker1").value; }
		function PA_MODALIDADE() { return $find("<%= ComboBox1.ClientID %>").get_value(); }
		function PA_ENQUADRAMENTO() { return document.getElementById("RadTextBox4").value; }
