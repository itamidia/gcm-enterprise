<%@ page language="C#" enableeventvalidation="True" validaterequest="false" autoeventwireup="true" inherits="gcmenterprise.Access, App_Web_o3n4gjlu" culture="auto" uiculture="auto" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
	<link rel="stylesheet" href="../Styles/Access.css?sv=1.127.2017" type="text/css" media="screen" title="no title" charset="utf-8" />
...
<script type="text/javascript" src="../JS/Access_USER.js?sv=1.127.2017" language="JavaScript"></script>
			...
			<div id="__MainDiv" class="c_MainDiv" FitToContent="True" MarginToContent="0">
				<div id="Div1" runat="server" AutoExpandToContent="False" AutoExpandToContentMargin="10">
					...
					<telerik:RadAjaxPanel id="AjaxPanel1" runat="server" LoadingPanelID="___AjaxPanel1_AjaxLoading">
						<div style="position:absolute !important;left:10px;top:40px;width:677px;height:741px">
							...
							<telerik:RadMultiPage runat="server" ID="TabControl5MultiPage" BorderColor="Transparent" BorderWidth="0" BorderStyle="Solid" Width="100%" Height="715px" SelectedIndex="0">
								<telerik:RadPageView id="TabPage1" runat="server" BackColor="#FFFFFF">
									...
									<telerik:RadToolBar id="tbSavePw" runat="server" EnableRoundedCorners="True" EnableShadows="True" Height="27"
										OnClientButtonClicking="ToolbarClickHandler" Orientation="Horizontal" RenderMode="Classic" Width="34">
										<Items>
								...
								<telerik:RadPageView id="TabPage2" runat="server" BackColor="#FFFFFF">
									...
									<asp:ListBox id="ListBox3" runat="server" AutoPostBack="True" OnSelectedIndexChanged="___ListBox3_OnSelectedIndexChanged"
										SelectionMode="Multiple" TabIndex="5" />
									...
									<asp:ListBox id="ListBox4" runat="server" AutoPostBack="True" OnSelectedIndexChanged="___ListBox4_OnSelectedIndexChanged"
										SelectionMode="Multiple" TabIndex="6" />
									...
									<telerik:RadToolBar id="tbGroup" runat="server" EnableRoundedCorners="True" EnableShadows="True" Height="29"
										OnClientButtonClicking="ToolbarClickHandler" Orientation="Horizontal" RenderMode="Classic" Width="133">
										<Items>
								...
								<telerik:RadPageView id="TabPage3" runat="server" BackColor="#FFFFFF">
									...
									<asp:ListBox id="ListBox6" runat="server" AutoPostBack="True" OnSelectedIndexChanged="___ListBox6_OnSelectedIndexChanged"
										SelectionMode="Multiple" TabIndex="18" />
									...
									<telerik:RadToolBar id="tbUser" runat="server" EnableRoundedCorners="True" EnableShadows="True" Height="31"
										OnClientButtonClicking="ToolbarClickHandler" Orientation="Horizontal" RenderMode="Classic" Width="133">
										<Items>
									...
									<telerik:RadTextBox id="RadTextBox1" runat="server" AutoPostBack="False" EnableSingleInputRendering="True" ForeColor="#000000" MaxLength="0"
										ReadOnly="False" RenderMode="Classic" TabIndex="27" TextMode="MultiLine" WrapperCssClass="c_RadTextBox1_wrapper" />
								</telerik:RadPageView>
