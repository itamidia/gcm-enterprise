<%@ page language="C#" validaterequest="false" enableeventvalidation="True" autoeventwireup="true" inherits="gcmenterprise.DataPages.Editar_Viaturas, App_Web_l2yf3rw0" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<link rel="stylesheet" href="../../Styles/Editar_Viaturas.css?sv=1.127.2017" type="text/css" media="screen" title="no title" charset="utf-8" />
...
<body onload="InitializeClient(); setTimeout(function() {Form1_onload(this);return false;}, 100);" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	...
	<script type="text/javascript" src="../../JS/Editar_Viaturas_USER.js?sv=1.127.2017" language="JavaScript"></script>
				...
				<div id="__MainDiv" class="c_MainDiv" FitToContent="True" MarginToContent="0">
					...
					<div id="Div2" runat="server" AutoExpandToContent="False" AutoExpandToContentMargin="10">
						<telerik:RadToolBar id="gToolbar" runat="server" EnableRoundedCorners="True" EnableShadows="True" Height="29"
							OnClientButtonClicking="ToolbarClickHandler" Orientation="Horizontal" RenderMode="Classic" Width="269">
							<Items>
					...
					<telerik:RadTextBox id="RadTextBox1" runat="server" AutoPostBack="False" enabled="false" EnableSingleInputRendering="True" ForeColor="#FE0202"
					...
					<telerik:RadTextBox id="RadTextBox4" runat="server" AutoPostBack="False" EnableSingleInputRendering="True" ForeColor="#000000" MaxLength="25"
						onkeydown="onTextChanged" ReadOnly="False" RenderMode="Classic" TabIndex="5" TextMode="SingleLine" WrapperCssClass="c_RadTextBox4_wrapper" />
					...
					<telerik:RadTextBox id="RadTextBox7" runat="server" AutoPostBack="False" EnableSingleInputRendering="True" ForeColor="#000000" MaxLength="7"
					...
					<telerik:RadTextBox id="RadTextBox8" runat="server" AutoPostBack="False" EnableSingleInputRendering="True" ForeColor="#000000" MaxLength="15"
					...
					<telerik:RadTextBox id="RadTextBox10" runat="server" AutoPostBack="False" EnableSingleInputRendering="True" ForeColor="#000000" MaxLength="10"
						onkeydown="onTextChanged" ReadOnly="False" RenderMode="Classic" TabIndex="13" TextMode="SingleLine" WrapperCssClass="c_RadTextBox10_wrapper" />
					...
					<telerik:RadTextBox id="RadTextBox11" runat="server" AutoPostBack="False" EnableSingleInputRendering="True" ForeColor="#000000" MaxLength="10"
						onkeydown="onTextChanged" ReadOnly="False" RenderMode="Classic" TabIndex="15" TextMode="SingleLine" WrapperCssClass="c_RadTextBox11_wrapper" />
					<telerik:RadLabel id="Label17" runat="server" Text="<%$ Resources: Label17 %>" />
					<telerik:RadTextBox id="RadTextBox12" runat="server" AutoPostBack="False" EnableSingleInputRendering="True" ForeColor="#000000" MaxLength="15"
						onkeydown="onTextChanged" ReadOnly="False" RenderMode="Classic" TabIndex="16" TextMode="SingleLine" WrapperCssClass="c_RadTextBox12_wrapper" />
					<telerik:RadLabel id="Label18" runat="server" Text="<%$ Resources: Label18 %>" />
					<telerik:RadTextBox id="RadTextBox13" runat="server" AutoPostBack="False" EnableSingleInputRendering="True" ForeColor="#000000" MaxLength="10"
					...
					<telerik:RadTextBox id="RadTextBox14" runat="server" AutoPostBack="False" EnableSingleInputRendering="True" ForeColor="#000000" MaxLength="10"
						onkeydown="onTextChanged" ReadOnly="False" RenderMode="Classic" TabIndex="18" TextMode="SingleLine" WrapperCssClass="c_RadTextBox14_wrapper" />
					...
					<telerik:RadDatePicker id="DatePicker1" runat="server" Calendar-ClientEvents-OnDateClick="HideDatePickerValidation"
						...
						EnableEmbeddedSkins="True" HideAnimation-Duration="300" HideAnimation-Type="Fade" MinDate="01/01/2000" PopupDirection="BottomRight"
						ReadOnly="False" RenderMode="Classic" ShowAnimation-Duration="300" ShowAnimation-Type="Fade" TabIndex="19" Width="236px">
					...
					<div id="Div3" runat="server" AutoExpandToContent="False" AutoExpandToContentMargin="10">
						...
						<telerik:RadLabel id="Label25" runat="server" />
	...
	<script type="text/javascript">
		...
		function VIA_N_PATRIMONIO() { return document.getElementById("RadTextBox2").value; }
		function VIA_VIATURA() { return document.getElementById("RadTextBox3").value; }
		function VIA_MARCA() { return document.getElementById("RadTextBox4").value; }
		function VIA_MODELO() { return document.getElementById("RadTextBox5").value; }
		function VIA_VERSAO() { return document.getElementById("RadTextBox6").value; }
		function VIA_PLACA() { return document.getElementById("RadTextBox7").value; }
		function VIA_RENAVAN() { return document.getElementById("RadTextBox8").value; }
		function VIA_CHASSI() { return document.getElementById("RadTextBox9").value; }
		function VIA_PREFIXO() { return document.getElementById("RadTextBox10").value; }
		function VIA_COMBUSTIVEL() { return $find("<%= ComboBox2.ClientID %>").get_value(); }
		...
		function VIA_ANO() { return document.getElementById("RadTextBox13").value; }
		function VIA_ANO_MODELO() { return document.getElementById("RadTextBox14").value; }
		function VIA_DATA_AQUISICAO() { return document.getElementById("DatePicker1").value; }
		function VIA_VALOR() { return document.getElementById("RadTextBox15").value; }
		function VIA_STATUS() { return $find("<%= ComboBox3.ClientID %>").get_value(); }
		function VIA_TIPO() { return $find("<%= ComboBox4.ClientID %>").get_value(); }
		...
		{
					try { document.getElementById("Label25").innerText = (PageProvider.MainProvider.DataProvider.PageNumber).toString(); }
					catch(e) { document.getElementById("Label25").innerText = ""; }
					try { document.getElementById("Label27").innerText = (PageProvider.MainProvider.DataProvider.PageCount).toString(); }
