<%@ page language="C#" autoeventwireup="true" enableeventvalidation="True" inherits="gcmenterprise.ConstructorView, App_Web_o3n4gjlu" culture="auto" uiculture="auto" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" lang="<%=gcmenterprise.Utility.CurrentSiteLanguage%>">
<head runat="server">
	<title><asp:Literal runat="server" Text="<%$ Resources: Form1 %>" /></title>
	<link rel="stylesheet" href="../Styles/ConstructorView.css?sv=1.127.2017" type="text/css" media="screen" title="no title" charset="utf-8" />
</head>
...
<script type="text/javascript" src="../JS/ConstructorView_USER.js?sv=1.127.2017" language="JavaScript"></script>
			...
			<div id="__MainDiv" class="c_MainDiv" FitToContent="True" MarginToContent="0">
				<div id="Div1" runat="server" AutoExpandToContent="True" AutoExpandToContentMargin="10">
					...
					<telerik:RadAjaxPanel id="ControlsAjaxPanel" runat="server" LoadingPanelID="___ControlsAjaxPanel_AjaxLoading">
						...
						<telerik:RadTextBox id="txtViews" runat="server" AutoPostBack="False" EnableSingleInputRendering="True" ForeColor="#000000" MaxLength="0"
							...
							<div style="position:absolute !important;left:0px;top:0px;width:650px;height:344px">
								...
								<telerik:RadMultiPage runat="server" ID="TabControl1MultiPage" BorderColor="#000000" BorderWidth="1" BorderStyle="Solid" Width="100%" Height="318px" SelectedIndex="0">
									...
									<telerik:RadPageView id="TabPage3" runat="server" BackColor="#FFFFFF">
										<telerik:RadTextBox id="txtTopRegisters" runat="server" AutoPostBack="False" EnableSingleInputRendering="True" ForeColor="#000000"
										...
										<telerik:RadTextBox id="txtJoinAlias" runat="server" AutoPostBack="False" EnableSingleInputRendering="True" ForeColor="#000000"
