<%@ page language="C#" validaterequest="false" enableeventvalidation="True" autoeventwireup="true" inherits="gcmenterprise.DataPages.Listagem_Geral_de_Ocorrencias, App_Web_mj1bal1d" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<link rel="stylesheet" href="../../Styles/Listagem_Geral_de_Ocorrencias.css?sv=1.127.2017" type="text/css" media="screen" title="no title" charset="utf-8" />
...
<body onload="InitializeClient(); setTimeout(function() {Form1_onload(this);return false;}, 100);" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	...
	<script type="text/javascript" src="../../JS/Listagem_Geral_de_Ocorrencias_USER.js?sv=1.127.2017" language="JavaScript"></script>
						...
						<MasterTableView  AllowCustomPaging="true" CommandItemDisplay="Top" EditMode="InPlace" EnableEmbeddedSkins="True" OnItemCreated="Grid1_ItemCreated" OnUpdateCommand="Grid_UpdateCommand" Skin="MetroTouch">
							<Columns>
								...
								<telerik:GridBoundColumn UniqueName="GridColumn2" runat="server" AllowFiltering="True" AllowSorting="true" ConvertEmptyStringToNull="False"
									DataField="OCO_CODIGO" Exportable="True" FilterControlWidth="58" ForceExtractValue="Always" HeaderStyle-Width="93"
								...
								<telerik:GridBoundColumn UniqueName="GridColumn3" runat="server" AllowFiltering="True" AllowSorting="true" ConvertEmptyStringToNull="False"
									DataField="OCO_OCORRENCIA" Exportable="True" FilterControlWidth="288" ForceExtractValue="Always" HeaderStyle-Width="323"
									HeaderText="<%$ Resources: GridColumn3 %>" ItemStyle-Width="316" MaxLength="50" ReadOnly="False" Visible="True" />
								<telerik:GridBoundColumn UniqueName="GridColumn4" runat="server" AllowFiltering="True" AllowSorting="true" ConvertEmptyStringToNull="False"
									DataField="OCO_CLASSIFICACAO" Exportable="True" FilterControlWidth="126" ForceExtractValue="Always" HeaderStyle-Width="161"
									HeaderText="<%$ Resources: GridColumn4 %>" ItemStyle-Width="154" MaxLength="35" ReadOnly="False" Visible="True" />
								<telerik:GridBoundColumn UniqueName="GridColumn5" runat="server" AllowFiltering="True" AllowSorting="true" ConvertEmptyStringToNull="False"
									DataField="OCO_LEI" Exportable="True" FilterControlWidth="107" ForceExtractValue="Always" HeaderStyle-Width="142"
									HeaderText="<%$ Resources: GridColumn5 %>" ItemStyle-Width="135" MaxLength="50" ReadOnly="False" Visible="True" />
