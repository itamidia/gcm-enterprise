<%@ page language="C#" validaterequest="false" enableeventvalidation="True" autoeventwireup="true" inherits="gcmenterprise.DataPages.Estoque_Filtros, App_Web_mj1bal1d" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<link rel="stylesheet" href="../../Styles/Estoque_Filtros.css?sv=1.127.2017" type="text/css" media="screen" title="no title" charset="utf-8" />
...
<body onload="InitializeClient();" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	...
	<script type="text/javascript" src="../../JS/Estoque_Filtros_USER.js?sv=1.127.2017" language="JavaScript"></script>
						...
						<MasterTableView  AllowCustomPaging="true" CommandItemDisplay="Top" DataKeyNames="ESTOQUE_ID" EditMode="InPlace" OnItemCreated="Grid1_ItemCreated" OnUpdateCommand="Grid_UpdateCommand">
							<Columns>
								<telerik:GridBoundColumn UniqueName="GridColumn1" runat="server" AllowFiltering="True" AllowSorting="true" ConvertEmptyStringToNull="False"
									DataField="ESTOQUE_ID" DataFormatString="{0:#########0}" Exportable="True" FilterControlWidth="31" FooterStyle-HorizontalAlign="Right"
								...
								<telerik:GridBoundColumn UniqueName="GridColumn9" runat="server" AllowFiltering="True" AllowSorting="true" ConvertEmptyStringToNull="False"
									DataField="ESTOQUE_N_CONTROLE" DataFormatString="{0:#########0}" Exportable="True" FilterControlWidth="45"
									FooterStyle-HorizontalAlign="Right" ForceExtractValue="Always" HeaderStyle-HorizontalAlign="Right" HeaderStyle-Width="80"
									HeaderText="<%$ Resources: GridColumn9 %>" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="73" MaxLength="10" ReadOnly="False"
									Visible="True" />
								<telerik:GridBoundColumn UniqueName="GridColumn2" runat="server" AllowFiltering="True" AllowSorting="true" ConvertEmptyStringToNull="False"
									...
									HeaderText="<%$ Resources: GridColumn2 %>" ItemStyle-Width="86" MaxLength="50" ReadOnly="False" Visible="True" />
								<telerik:GridTemplateColumn UniqueName="GridColumn3" runat="server" AllowFiltering="True" ConvertEmptyStringToNull="False"
									...
									GroupByExpression="ESTOQUE_GRUPO ESTOQUE_GRUPO Group By ESTOQUE_GRUPO" HeaderStyle-Width="93" HeaderText="<%$ Resources: GridColumn3 %>"
									...
									<ItemTemplate> 
										<asp:Label runat="server" ID="GridColumn3_Label" Text='<%#PageProvider.GetGridComboText("Grid1_GridColumn3", Eval("ESTOQUE_GRUPO").ToString())%>' Value='<%#Eval("ESTOQUE_GRUPO").ToString()%>'/>
									</ItemTemplate> 
									<FilterTemplate>
								...
								<telerik:GridTemplateColumn UniqueName="GridColumn4" runat="server" AllowFiltering="True" ConvertEmptyStringToNull="False"
									...
									HeaderText="<%$ Resources: GridColumn4 %>" ItemStyle-Width="86" ReadOnly="False" SortExpression="ESTOQUE_SUBGRUPO" Visible="True">
									<EditItemTemplate>
									...
									<ItemTemplate> 
										<asp:Label runat="server" ID="GridColumn4_Label" Text='<%#PageProvider.GetGridComboText("Grid1_GridColumn4", Eval("ESTOQUE_SUBGRUPO").ToString())%>' Value='<%#Eval("ESTOQUE_SUBGRUPO").ToString()%>'/>
									</ItemTemplate> 
									<FilterTemplate>
										<telerik:RadComboBox ID="GridColumn4_ComboBox_Filter" runat="server" AllowCustomText="False" TabIndex="1"
											...
											Width="78" ClientIDMode="Static" OnClientSelectedIndexChanging="GridColumn4_ComboBox_FilterIndexChanging"/>
								...
								<telerik:GridBoundColumn UniqueName="GridColumn7" runat="server" AllowFiltering="True" AllowSorting="true" ConvertEmptyStringToNull="False"
									...
									HeaderText="<%$ Resources: GridColumn7 %>" ItemStyle-Width="86" MaxLength="15" ReadOnly="False" Visible="True" />
								...
								<telerik:GridTemplateColumn UniqueName="GridColumn8" runat="server" AllowFiltering="True" ConvertEmptyStringToNull="False"
									...
									HeaderText="<%$ Resources: GridColumn8 %>" ItemStyle-Width="86" ReadOnly="False" SortExpression="ESTOQUE_FORNECEDOR" Visible="True">
									<EditItemTemplate>
									...
									<ItemTemplate> 
										<asp:Label runat="server" ID="GridColumn8_Label" Text='<%#PageProvider.GetGridComboText("Grid1_GridColumn8", Eval("ESTOQUE_FORNECEDOR").ToString())%>' Value='<%#Eval("ESTOQUE_FORNECEDOR").ToString()%>'/>
									</ItemTemplate> 
									<FilterTemplate>
										<telerik:RadComboBox ID="GridColumn8_ComboBox_Filter" runat="server" AllowCustomText="False" TabIndex="1"
											EnableLoadOnDemand="True" EnableVirtualScrolling="True" OnClientKeyPressing="Combo_HandleKeyPress" MaxHeight="100"
											OnClientItemsRequested="CheckComboItems" OnClientItemsRequesting="Combo_OnClientItemsRequesting"
								...
								<telerik:GridTemplateColumn UniqueName="GridColumn18" runat="server" AllowFiltering="True" ConvertEmptyStringToNull="False"
									DataField="ESTOQUE_DEPARTAMENTO" Exportable="True" FilterControlWidth="58" ForceExtractValue="Always"
									GroupByExpression="ESTOQUE_DEPARTAMENTO ESTOQUE_DEPARTAMENTO Group By ESTOQUE_DEPARTAMENTO" HeaderStyle-Width="93"
									HeaderText="<%$ Resources: GridColumn18 %>" ItemStyle-Width="86" ReadOnly="False" SortExpression="ESTOQUE_DEPARTAMENTO" Visible="True">
									<EditItemTemplate>
										<telerik:RadComboBox ID="GridColumn18_ComboBox" runat="server" MarkFirstMatch="True" AllowCustomText="False" 
											 AutoPostBack="False" EnableLoadOnDemand="True" EnableVirtualScrolling="True" MaxHeight="100"
											OnClientItemsRequested="CheckComboItems" OnClientItemsRequesting="Combo_OnClientItemsRequesting" DropDownAutoWidth ="Enabled"
											OnClientKeyPressing="Combo_HandleKeyPress" OnItemsRequested="___Grid1_GridColumn18_ComboBox_OnItemsRequested" ItemsPerRequest="15"
											Width="78" ClientIDMode="Static" />
									</EditItemTemplate>
									<ItemTemplate> 
										<asp:Label runat="server" ID="GridColumn18_Label" Text='<%#PageProvider.GetGridComboText("Grid1_GridColumn18", Eval("ESTOQUE_DEPARTAMENTO").ToString())%>' Value='<%#Eval("ESTOQUE_DEPARTAMENTO").ToString()%>'/>
									</ItemTemplate> 
									<FilterTemplate>
										<telerik:RadComboBox ID="GridColumn18_ComboBox_Filter" runat="server" AllowCustomText="False" TabIndex="1"
											EnableLoadOnDemand="True" EnableVirtualScrolling="True" OnClientKeyPressing="Combo_HandleKeyPress" MaxHeight="100"
											OnClientItemsRequested="CheckComboItems" OnClientItemsRequesting="Combo_OnClientItemsRequesting"
											OnItemsRequested="___Grid1_GridColumn18_ComboBox_OnItemsRequested" ItemsPerRequest="15"
											Width="78" ClientIDMode="Static" OnClientSelectedIndexChanging="GridColumn18_ComboBox_FilterIndexChanging"/>
										<telerik:RadScriptBlock ID="GridColumn18ScriptBlock" runat="server">
											<script type="text/javascript">
												function GridColumn18_ComboBox_FilterIndexChanging(sender, args) {
													if (sender.get_value() != args.get_item().get_value()) {
														var tableView = $find("<%# ((GridItem)Container).OwnerTableView.ClientID %>");
														tableView.filter("GridColumn18", args.get_item().get_value(), "EqualTo");
													}
												}
											</script>
										</telerik:RadScriptBlock>
