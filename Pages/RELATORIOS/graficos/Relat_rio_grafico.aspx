<%@ page language="C#" autoeventwireup="true" inherits="gcmenterprise.Reports.Relat_rio_grafico, App_Web_2htywqnl" %>
<%@ Register Assembly="Microsoft.ReportViewer.WebForms, Version=10.0.0.0, Culture=neutral, PublicKeyToken=B03F5F7F11D50A3A" Namespace="Microsoft.Reporting.WebForms" TagPrefix="rsweb" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
	<title>Relatório Grafico TEste</title>
</head>
	...
	<form id="form1" runat="server">
		<div runat="server" id="__MainDiv" style="overflow: hidden; background-color:White"   >
			<rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt"  SizeToReportContent="true">
            		<LocalReport ReportPath="Pages/RELATORIOS/graficos/Relat_rio_grafico.rdlc" />
			</rsweb:ReportViewer>
		</div>
