<%@ page language="C#" validaterequest="false" enableeventvalidation="True" autoeventwireup="true" inherits="gcmenterprise.DataPages.Galeria_de_Imagens___Info_Crime, App_Web_4xdugpm1" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<link rel="stylesheet" href="../../Styles/Galeria_de_Imagens___Info_Crime.css?sv=1.127.2017" type="text/css" media="screen" title="no title" charset="utf-8" />
...
<body onload="InitializeClient();" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	...
	<script type="text/javascript" src="../../JS/Galeria_de_Imagens___Info_Crime_USER.js?sv=1.127.2017" language="JavaScript"></script>
				...
				<div id="__MainDiv" class="c_MainDiv" FitToContent="True" MarginToContent="0">
					...
					<div id="Div2" runat="server" AutoExpandToContent="False" AutoExpandToContentMargin="10">
						<telerik:RadToolBar id="gToolbar" runat="server" EnableRoundedCorners="True" EnableShadows="True" Height="29"
							OnClientButtonClicking="ToolbarClickHandler" Orientation="Horizontal" RenderMode="Classic" Width="250">
							<Items>
					...
					<telerik:RadTextBox id="RadTextBox2" runat="server" AutoPostBack="False" data-validation-engine="validate[funcCall[RadTextBox2_Validation]]"
						data-validation-message="ID_INFO_CRIME não pode ser vazio!" EnableSingleInputRendering="True" ForeColor="#000000" MaxLength="10"
					...
					<gas:GMultiMedia id="GMultiMedia1" runat="server" AllowFileExtensions=".jpg,.jpeg,.png" BorderWidth="1" CanDownloadFile="True"
						CanUploadFile="True" enabled="true" EncryptedFile="False" Height="328px" Left="161px" MaxFileSize="0" Path="~/Images/Delinquentes/"
						SaveAsFile="True" SessionHandlerObjectName="URL28581" ShowDownloadLink="True" ShowImage="True" TabIndex="3" Top="60px" Visible="true"
						Width="379px" />
				</div>
	...
	<script type="text/javascript">
		...
		function ID_INFO_CRIME() { return document.getElementById("RadTextBox2").value; }
