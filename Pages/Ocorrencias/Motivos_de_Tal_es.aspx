<%@ page language="C#" validaterequest="false" enableeventvalidation="True" autoeventwireup="true" inherits="gcmenterprise.DataPages.Motivos_de_Tal_es, App_Web_4xdugpm1" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<link rel="stylesheet" href="../../Styles/Motivos_de_Tal_es.css?sv=1.127.2017" type="text/css" media="screen" title="no title" charset="utf-8" />
...
<body onload="InitializeClient(); setTimeout(function() {Form1_onload(this);return false;}, 100);" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	...
	<script type="text/javascript" src="../../JS/Motivos_de_Tal_es_USER.js?sv=1.127.2017" language="JavaScript"></script>
				...
				<div id="__MainDiv" class="c_MainDiv" FitToContent="True" MarginToContent="0">
					...
					<div id="Div2" runat="server" AutoExpandToContent="False" AutoExpandToContentMargin="10">
						<telerik:RadToolBar id="gToolbar" runat="server" EnableRoundedCorners="True" EnableShadows="True" Height="29"
							OnClientButtonClicking="ToolbarClickHandler" Orientation="Horizontal" RenderMode="Classic" Width="267">
							<Items>
					...
					<telerik:RadTextBox id="RadTextBox2" runat="server" AutoPostBack="False" data-validation-engine="validate[funcCall[RadTextBox2_Validation]]"
						data-validation-message="MOTIVO_DESCRICAO não pode ser vazio!" EnableSingleInputRendering="True" ForeColor="#000000" MaxLength="50"
						...
						<MasterTableView  AllowCustomPaging="true" CommandItemDisplay="Top" EditMode="InPlace" OnItemCreated="Grid1_ItemCreated" OnUpdateCommand="Grid_UpdateCommand">
							<Columns>
								...
								<telerik:GridBoundColumn UniqueName="GridColumn1" runat="server" AllowFiltering="True" AllowSorting="true" ConvertEmptyStringToNull="False"
									DataField="ID_MOTIVO_TALAO" DataFormatString="{0:#########0}" Exportable="True" FilterControlWidth="58" FooterStyle-HorizontalAlign="Right"
								...
								<telerik:GridBoundColumn UniqueName="GridColumn2" runat="server" AllowFiltering="True" AllowSorting="true" ConvertEmptyStringToNull="False"
									DataField="MOTIVO_DESCRICAO" Exportable="True" FilterControlWidth="378" ForceExtractValue="Always" HeaderStyle-Width="413"
									HeaderText="<%$ Resources: GridColumn2 %>" ItemStyle-Width="406" MaxLength="50" ReadOnly="False" Visible="True" />
	...
	<script type="text/javascript">
		...
		function ID_MOTIVO_TALAO() { return document.getElementById("RadTextBox1").value; }
		function MOTIVO_DESCRICAO() { return document.getElementById("RadTextBox2").value; }
