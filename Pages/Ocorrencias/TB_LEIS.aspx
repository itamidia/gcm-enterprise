<%@ page language="C#" validaterequest="false" enableeventvalidation="True" autoeventwireup="true" inherits="gcmenterprise.DataPages.TB_LEIS, App_Web_bisnh1gg" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<link rel="stylesheet" href="../../Styles/TB_LEIS.css?sv=1.127.2017" type="text/css" media="screen" title="no title" charset="utf-8" />
...
<body onload="InitializeClient();" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	...
	<script type="text/javascript" src="../../JS/TB_LEIS_USER.js?sv=1.127.2017" language="JavaScript"></script>
			...
			<telerik:RadAjaxPanel id="MainAjaxPanel" runat="server" class="c_MainAjaxPanel" ClientEvents-OnRequestStart="OnRequestStart" ClientEvents-OnResponseEnd="OnResponseEnd" LoadingPanelID="___Form1_AjaxLoading">
				<div id="__MainDiv" class="c_MainDiv" FitToContent="True" MarginToContent="0">
					...
					<telerik:RadTextBox id="RadTextBox2" runat="server" AutoPostBack="False" data-validation-engine="validate[funcCall[RadTextBox2_Validation]]"
						data-validation-message="LEI não pode ser vazio!" EnableSingleInputRendering="True" ForeColor="#000000" MaxLength="180"
					...
					<div style="position:absolute !important;left:30px;top:138px;width:884px;height:483px">
						...
						<telerik:RadMultiPage runat="server" ID="TabControl1MultiPage" BorderColor="#000000" BorderWidth="1" BorderStyle="Solid" Width="100%" Height="457px" SelectedIndex="0">
							<telerik:RadPageView id="TabPage1" runat="server" BackColor="#FFFFFF">
								<gas:GEditor id="GEditor1" runat="server" EnableEmbeddedSkins="True" TabIndex="5" ViewMode="Design" />
							</telerik:RadPageView>
							<telerik:RadPageView id="TabPage2" runat="server" BackColor="#FFFFFF">
								<telerik:RadGrid id="Grid1" runat="server" AllowCustomPaging="true" AllowFilteringByColumn="True" AllowPaging="True" AllowSorting="True"
									...
									OnUpdateCommand="Grid_UpdateCommand" PageSize="10" RenderMode="Classic" ShowGroupPanel="False" TabIndex="4" TableLayout="Fixed">
									<MasterTableView  AllowCustomPaging="true" CommandItemDisplay="Top" DataKeyNames="ID" EditMode="InPlace" OnItemCreated="Grid1_ItemCreated" OnUpdateCommand="Grid_UpdateCommand">
										<Columns>
											...
											<telerik:GridBoundColumn UniqueName="GridColumn1" runat="server" AllowFiltering="True" AllowSorting="true"
												ConvertEmptyStringToNull="False" DataField="ID" DataFormatString="{0:#########0}" Exportable="True" FilterControlWidth="35"
												FooterStyle-HorizontalAlign="Right" ForceExtractValue="Always" HeaderStyle-HorizontalAlign="Right" HeaderStyle-Width="70"
												HeaderText="<%$ Resources: GridColumn1 %>" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="63" MaxLength="10" ReadOnly="False"
												Visible="True" />
											<telerik:GridBoundColumn UniqueName="GridColumn2" runat="server" AllowFiltering="True" AllowSorting="true"
												ConvertEmptyStringToNull="False" DataField="LEI" Exportable="True" FilterControlWidth="124" ForceExtractValue="Always"
												HeaderStyle-Width="159" HeaderText="<%$ Resources: GridColumn2 %>" ItemStyle-Width="152" MaxLength="180" ReadOnly="False" Visible="True" />
											<telerik:GridTemplateColumn UniqueName="GridColumn3" runat="server" AllowFiltering="True" ConvertEmptyStringToNull="False"
												DataField="TIPO_LEI" Exportable="True" FilterControlWidth="111" ForceExtractValue="Always"
												GroupByExpression="TIPO_LEI TIPO_LEI Group By TIPO_LEI" HeaderStyle-Width="146" HeaderText="<%$ Resources: GridColumn3 %>"
												ItemStyle-Width="139" ReadOnly="False" SortExpression="TIPO_LEI" Visible="True">
												<EditItemTemplate>
													<telerik:RadComboBox ID="GridColumn3_ComboBox" runat="server" MarkFirstMatch="True" AllowCustomText="False" 
														...
														Width="131" ClientIDMode="Static" />
												</EditItemTemplate>
												<ItemTemplate> 
													<asp:Label runat="server" ID="GridColumn3_Label" Text='<%#PageProvider.GetGridComboText("Grid1_GridColumn3", Eval("TIPO_LEI").ToString())%>' Value='<%#Eval("TIPO_LEI").ToString()%>'/>
												</ItemTemplate> 
												<FilterTemplate>
													<telerik:RadComboBox ID="GridColumn3_ComboBox_Filter" runat="server" AllowCustomText="False" TabIndex="1"
														...
														Width="131" ClientIDMode="Static" OnClientSelectedIndexChanging="GridColumn3_ComboBox_FilterIndexChanging"/>
											...
											<telerik:GridBoundColumn UniqueName="GridColumn4" runat="server" AllowFiltering="True" AllowSorting="true"
												ConvertEmptyStringToNull="False" DataField="DESCRICAO" Exportable="True" FilterControlWidth="329" ForceExtractValue="Always"
												HeaderStyle-Width="364" HeaderText="<%$ Resources: GridColumn4 %>" ItemStyle-Width="357" MaxLength="10" ReadOnly="False" Visible="True" />
										...
										<CommandItemSettings ShowAddNewRecordButton="True" AddNewRecordText="" RefreshText=""  ShowExportToExcelButton="true" ShowExportToPdfButton="true"/>
									</MasterTableView>
	...
	<script type="text/javascript">
		...
		function LEI() { return document.getElementById("RadTextBox2").value; }
		function TIPO_LEI() { return $find("<%= ComboBox1.ClientID %>").get_value(); }
