<%@ page language="C#" validaterequest="false" enableeventvalidation="True" autoeventwireup="true" inherits="gcmenterprise.DataPages.Boletim_de_Ocorrencia_Encerramento, App_Web_4xdugpm1" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<link rel="stylesheet" href="../../Styles/Boletim_de_Ocorrencia_Encerramento.css?sv=1.127.2017" type="text/css" media="screen" title="no title" charset="utf-8" />
...
<body onload="InitializeClient();" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	...
	<script type="text/javascript" src="../../JS/Boletim_de_Ocorrencia_Encerramento_USER.js?sv=1.127.2017" language="JavaScript"></script>
				...
				<div id="__MainDiv" class="c_MainDiv" FitToContent="True" MarginToContent="0">
					...
					<div id="Div2" runat="server" AutoExpandToContent="False" AutoExpandToContentMargin="10">
						<telerik:RadToolBar id="gToolbar" runat="server" EnableRoundedCorners="True" EnableShadows="True" Height="29"
							...
							<Items>
								<telerik:RadToolBarButton id="Button1" runat="server" CssClass="Button1" CommandArgument="Button1" CommandName="Button1" TabIndex="24"
									ToolTip="Cria novo registro" />
								<telerik:RadToolBarButton id="Button2" runat="server" CssClass="Button2" CommandArgument="Button2" CommandName="Button2" TabIndex="25"
									ToolTip="Grava alterações do registro atual" />
								<telerik:RadToolBarButton id="Button3" runat="server" CssClass="Button3" CommandArgument="Button3" CommandName="Button3" TabIndex="26"
									ToolTip="Cancela modificações no registro atual" />
								<telerik:RadToolBarButton id="Button4" runat="server" CssClass="Button4" CommandArgument="Button4" CommandName="Button4" TabIndex="27"
									ToolTip="Excluir registro atual" />
								<telerik:RadToolBarButton id="Button6" runat="server" CssClass="Button6" CommandArgument="Button6" CommandName="Button6" TabIndex="28"
									ToolTip="Mover para o registro anterior" />
								<telerik:RadToolBarButton id="Button7" runat="server" CssClass="Button7" CommandArgument="Button7" CommandName="Button7" TabIndex="29"
									ToolTip="Mover para o próximo registro" />
								<telerik:RadToolBarButton id="Button9" runat="server" CssClass="Button9" CommandArgument="Button9" CommandName="Button9" TabIndex="30"
									ToolTip="Especifica expressão de filtragem" />
								<telerik:RadToolBarButton id="Button10" runat="server" CssClass="Button10" CommandArgument="Button10" CommandName="Button10" TabIndex="31"
					...
					<telerik:RadTextBox id="RadTextBox7" runat="server" AutoPostBack="False" EnableSingleInputRendering="True" ForeColor="#000000" MaxLength="100"
					...
					<telerik:RadTextBox id="RadTextBox8" runat="server" AutoPostBack="False" EnableSingleInputRendering="True" ForeColor="#000000" MaxLength="35"
					...
					<telerik:RadTextBox id="RadTextBox10" runat="server" AutoPostBack="False" EnableSingleInputRendering="True" ForeColor="#000000" MaxLength="10"
						onkeydown="onTextChanged" ReadOnly="False" RenderMode="Classic" TabIndex="10" TextMode="SingleLine" WrapperCssClass="c_RadTextBox10_wrapper" />
					...
					<telerik:RadTextBox id="RadTextBox12" runat="server" AutoPostBack="False" EnableSingleInputRendering="True" ForeColor="#000000" MaxLength="100"
					...
					<telerik:RadComboBox id="ComboBox2" runat="server" AllowCustomText="False" AutoPostBack="False" CollapseAnimation-Duration="300"
						...
						OnClientItemsRequested="CheckComboItems" OnClientItemsRequesting="Combo_OnClientItemsRequesting" OnClientKeyPressing="Combo_HandleKeyPress"
						OnItemsRequested="___ComboBox2_OnItemsRequested" RenderMode="Classic" TabIndex="13" />
					...
					<telerik:RadComboBox id="ComboBox3" runat="server" AllowCustomText="False" AutoPostBack="False" CollapseAnimation-Duration="300"
						...
						OnClientItemsRequested="CheckComboItems" OnClientItemsRequesting="Combo_OnClientItemsRequesting" OnClientKeyPressing="Combo_HandleKeyPress"
						OnItemsRequested="___ComboBox3_OnItemsRequested" RenderMode="Classic" TabIndex="14" />
					<telerik:RadLabel id="Label19" runat="server" Text="<%$ Resources: Label19 %>" />
					<telerik:RadTextBox id="RadTextBox13" runat="server" AutoPostBack="False" EnableSingleInputRendering="True" ForeColor="#000000" MaxLength="0"
						onkeydown="onTextChanged" ReadOnly="False" RenderMode="Classic" TabIndex="15" TextMode="MultiLine" WrapperCssClass="c_RadTextBox13_wrapper" />
					...
					<telerik:RadTextBox id="RadTextBox14" runat="server" AutoPostBack="False" EnableSingleInputRendering="True" ForeColor="#000000" MaxLength="0"
						onkeydown="onTextChanged" ReadOnly="False" RenderMode="Classic" TabIndex="16" TextMode="MultiLine" WrapperCssClass="c_RadTextBox14_wrapper" />
					...
					<telerik:RadTextBox id="RadTextBox15" runat="server" AutoPostBack="False" EnableSingleInputRendering="True" ForeColor="#000000" MaxLength="0"
						onkeydown="onTextChanged" ReadOnly="False" RenderMode="Classic" TabIndex="17" TextMode="MultiLine" WrapperCssClass="c_RadTextBox15_wrapper" />
					<telerik:RadLabel id="Label22" runat="server" Text="<%$ Resources: Label22 %>" />
					<telerik:RadTextBox id="RadTextBox16" runat="server" AutoPostBack="False" EnableSingleInputRendering="True" ForeColor="#000000" MaxLength="14"
						onkeydown="onTextChanged" ReadOnly="False" RenderMode="Classic" TabIndex="18" TextMode="SingleLine" WrapperCssClass="c_RadTextBox16_wrapper" />
					...
					<telerik:RadDateTimePicker id="DatePicker1" runat="server" Calendar-ClientEvents-OnDateClick="HideDatePickerValidation"
						...
						PopupDirection="BottomRight" ReadOnly="False" RenderMode="Classic" ShowAnimation-Duration="300" ShowAnimation-Type="Fade" TabIndex="19"
						TimeView-EndTime="23:00" TimeView-StartTime="00:00" Width="360px">
					...
					<telerik:RadComboBox id="ComboBox4" runat="server" disable-data-validation-onblur AllowCustomText="False" AutoPostBack="False"
						...
						OnClientKeyPressing="Combo_HandleKeyPress" OnItemsRequested="___ComboBox4_OnItemsRequested" RenderMode="Classic" TabIndex="22" />
	...
	<script type="text/javascript">
		...
		function BOL_STATUS() { return document.getElementById("RadTextBox3").value; }
		function BOL_SOLICITANTE() { return document.getElementById("RadTextBox4").value; }
		function BOL_TELEFONE() { return document.getElementById("RadTextBox5").value; }
		function BOL_TIPO_LOGRADOURO() { return document.getElementById("RadTextBox6").value; }
		function BOL_LOGRADOURO() { return document.getElementById("RadTextBox7").value; }
		function BOL_BAIRRO() { return document.getElementById("RadTextBox8").value; }
		function BOL_CIDADE() { return document.getElementById("RadTextBox9").value; }
		function BOL_UF() { return document.getElementById("RadTextBox10").value; }
		function BOL_CEP() { return document.getElementById("RadTextBox11").value; }
		function BOL_REFERENCIA() { return document.getElementById("RadTextBox12").value; }
		function BOL_NATUREZA() { return $find("<%= ComboBox2.ClientID %>").get_value(); }
		function BOL_NATUREZA_FINAL() { return $find("<%= ComboBox3.ClientID %>").get_value(); }
		function BOL_RESUMO() { return document.getElementById("RadTextBox13").value; }
		function BOL_HISTORICO() { return document.getElementById("RadTextBox14").value; }
		function BOL_HISTORICO_FINAL() { return document.getElementById("RadTextBox15").value; }
		function BOL_NUMERO() { return document.getElementById("RadTextBox16").value; }
		function BOL_DATA() { return document.getElementById("DatePicker1").value; }
		function BOL_NUM_TALAO() { return document.getElementById("RadTextBox17").value; }
		function BOL_DATA_FIM() { return document.getElementById("DatePicker2").value; }
		function BOL_VIATURA() { return $find("<%= ComboBox4.ClientID %>").get_value(); }
