<%@ page language="C#" validaterequest="false" enableeventvalidation="True" autoeventwireup="true" inherits="gcmenterprise.DataPages.Descautelar_Materiais___Permanente, App_Web_g4o5dsry" culture="auto" uiculture="auto" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" lang="<%=gcmenterprise.Utility.CurrentSiteLanguage%>">
<head id="Head1" runat="server">
	<title><asp:Literal runat="server" Text="<%$ Resources: Form1 %>" /></title>
	<link rel="stylesheet" href="../../Styles/Descautelar_Materiais___Permanente.css?sv=1.127.2017" type="text/css" media="screen" title="no title" charset="utf-8" />
...
<body onload="InitializeClient(); setTimeout(function() {Edit(this);return false;}, 100);" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	...
	<script type="text/javascript" src="../../JS/Descautelar_Materiais___Permanente_USER.js?sv=1.127.2017" language="JavaScript"></script>
			...
			<telerik:RadAjaxPanel id="MainAjaxPanel" runat="server" class="c_MainAjaxPanel" ClientEvents-OnRequestStart="OnRequestStart" ClientEvents-OnResponseEnd="OnResponseEnd" LoadingPanelID="___Form1_AjaxLoading">
				<div id="__MainDiv" class="c_MainDiv" FitToContent="True" MarginToContent="0">
					...
					<telerik:RadComboBox id="ComboBoxStatus" runat="server" AllowCustomText="False" AutoPostBack="False" CollapseAnimation-Duration="300"
						...
						OnItemsRequested="___ComboBoxStatus_OnItemsRequested" RenderMode="Classic" TabIndex="13" />
					...
					<telerik:RadTextBox id="RadTextBox2" runat="server" AutoPostBack="False" enabled="false" EnableSingleInputRendering="True" ForeColor="#000000"
						MaxLength="20" onkeydown="onTextChanged" ReadOnly="False" RenderMode="Classic" TabIndex="15" TextMode="SingleLine"
					...
					<telerik:RadDateTimePicker id="DatePicker1" runat="server" ClientEvents-OnDateSelected="setDatePickerFocus"
						...
						ReadOnly="False" RenderMode="Classic" ShowAnimation-Duration="300" ShowAnimation-Type="Fade" TabIndex="16" TimeView-EndTime="23:00"
						TimeView-StartTime="00:00" Width="200px">
					...
					<telerik:RadTextBox id="RadTextBox6" runat="server" AutoPostBack="False" enabled="false" EnableSingleInputRendering="True" ForeColor="#000000"
					...
					<telerik:RadComboBox id="ComboBox3" runat="server" AllowCustomText="False" AutoPostBack="False" CollapseAnimation-Duration="300"
						...
						OnClientItemsRequesting="Combo_OnClientItemsRequesting" OnClientKeyPressing="Combo_HandleKeyPress"
						OnItemsRequested="___ComboBox3_OnItemsRequested" RenderMode="Classic" TabIndex="18" />
					...
					<telerik:RadComboBox id="TextBoxCarregador" runat="server" AllowCustomText="False" AutoPostBack="False" CollapseAnimation-Duration="300"
						...
						OnClientItemsRequesting="Combo_OnClientItemsRequesting" OnClientKeyPressing="Combo_HandleKeyPress"
						OnItemsRequested="___TextBoxCarregador_OnItemsRequested" RenderMode="Classic" TabIndex="4" />
					...
					<telerik:RadComboBox id="ComboBox5" runat="server" AllowCustomText="False" AutoPostBack="False" CollapseAnimation-Duration="300"
						...
						OnClientItemsRequested="CheckComboItems" OnClientItemsRequesting="Combo_OnClientItemsRequesting" OnClientKeyPressing="Combo_HandleKeyPress"
						OnItemsRequested="___ComboBox5_OnItemsRequested" RenderMode="Classic" TabIndex="19" />
					...
					<telerik:RadComboBox id="TextBoxRadio" runat="server" AllowCustomText="False" AutoPostBack="False" CollapseAnimation-Duration="300"
						...
						OnClientItemsRequested="CheckComboItems" OnClientItemsRequesting="Combo_OnClientItemsRequesting" OnClientKeyPressing="Combo_HandleKeyPress"
						OnItemsRequested="___TextBoxRadio_OnItemsRequested" RenderMode="Classic" TabIndex="9" />
					...
					<telerik:RadComboBox id="ComboBox7" runat="server" AllowCustomText="False" AutoPostBack="False" CollapseAnimation-Duration="300"
						...
						OnClientItemsRequesting="Combo_OnClientItemsRequesting" OnClientKeyPressing="Combo_HandleKeyPress"
						OnItemsRequested="___ComboBox7_OnItemsRequested" RenderMode="Classic" TabIndex="20" />
					...
					<telerik:RadComboBox id="TextBoxAlgema" runat="server" AllowCustomText="False" AutoPostBack="False" CollapseAnimation-Duration="300"
						...
						OnClientItemsRequesting="Combo_OnClientItemsRequesting" OnClientKeyPressing="Combo_HandleKeyPress"
						OnItemsRequested="___TextBoxAlgema_OnItemsRequested" RenderMode="Classic" TabIndex="6" />
					...
					<telerik:RadComboBox id="ComboBox9" runat="server" AllowCustomText="False" AutoPostBack="False" CollapseAnimation-Duration="300"
						...
						OnClientItemsRequesting="Combo_OnClientItemsRequesting" OnClientKeyPressing="Combo_HandleKeyPress"
						OnItemsRequested="___ComboBox9_OnItemsRequested" RenderMode="Classic" TabIndex="21" />
					...
					<telerik:RadComboBox id="TextBoxColete" runat="server" AllowCustomText="False" AutoPostBack="False" CollapseAnimation-Duration="300"
						...
						OnClientItemsRequesting="Combo_OnClientItemsRequesting" OnClientKeyPressing="Combo_HandleKeyPress"
						OnItemsRequested="___TextBoxColete_OnItemsRequested" RenderMode="Classic" TabIndex="8" />
					...
					<telerik:RadComboBox id="ComboBox11" runat="server" AllowCustomText="False" AutoPostBack="False" CollapseAnimation-Duration="300"
						CollapseAnimation-Type="None" enabled="false" EnableEmbeddedSkins="True" EnableLoadOnDemand="True" EnableVirtualScrolling="True"
						ExpandAnimation-Duration="300" ExpandAnimation-Type="None" LoadingMessage="<%$ Resources: ComboBox11 %>" MarkFirstMatch="true" MaxHeight="100"
						OnClientItemsRequesting="Combo_OnClientItemsRequesting" OnClientKeyPressing="Combo_HandleKeyPress"
						OnItemsRequested="___ComboBox11_OnItemsRequested" RenderMode="Classic" TabIndex="22" />
					...
					<telerik:RadComboBox id="TextBoxTonfa" runat="server" AllowCustomText="False" AutoPostBack="False" CollapseAnimation-Duration="300"
						...
						OnClientItemsRequesting="Combo_OnClientItemsRequesting" OnClientKeyPressing="Combo_HandleKeyPress"
						OnItemsRequested="___TextBoxTonfa_OnItemsRequested" RenderMode="Classic" TabIndex="7" />
					...
					<telerik:RadTextBox id="TextBoxArmeiro" runat="server" AutoPostBack="False" EnableSingleInputRendering="True" ForeColor="#000000" MaxLength="20"
						onkeydown="onTextChanged" ReadOnly="False" RenderMode="Classic" TabIndex="1" TextMode="SingleLine" WrapperCssClass="c_TextBoxArmeiro_wrapper" />
					...
					<telerik:RadDateTimePicker id="TextBoxDp2" runat="server" ClientEvents-OnDateSelected="setDatePickerFocus"
						...
						ShowAnimation-Duration="300" ShowAnimation-Type="Fade" TabIndex="2" TimeView-EndTime="23:00" TimeView-StartTime="00:00" Width="200px">
					</telerik:RadDateTimePicker>
					...
					<telerik:RadTextBox id="RadTextBox13" runat="server" AutoPostBack="False" EnableSingleInputRendering="True" ForeColor="#000000" MaxLength="0"
						onkeydown="onTextChanged" ReadOnly="False" RenderMode="Classic" TabIndex="12" TextMode="MultiLine" WrapperCssClass="c_RadTextBox13_wrapper" />
					<telerik:RadLabel id="Label31" runat="server" Text="<%$ Resources: Label31 %>" />
					<telerik:RadTextBox id="TextBoxMunicao" runat="server" AutoPostBack="False" EnableSingleInputRendering="True" ForeColor="#000000" MaxLength="25"
						onkeydown="onTextChanged" ReadOnly="False" RenderMode="Classic" TabIndex="5" TextMode="SingleLine" WrapperCssClass="c_TextBoxMunicao_wrapper" />
					...
					<div id="Div3" runat="server" AutoExpandToContent="False" AutoExpandToContentMargin="10">
						...
						<telerik:RadLabel id="Label35" runat="server" />
						<telerik:RadLabel id="Label36" runat="server" Text="<%$ Resources: Label36 %>" />
						<telerik:RadLabel id="Label37" runat="server" />
					...
					<telerik:RadComboBox id="TextBoxArmaDev" runat="server" AllowCustomText="False" AutoPostBack="False" CollapseAnimation-Duration="300"
						...
						OnClientItemsRequested="CheckComboItems" OnClientItemsRequesting="Combo_OnClientItemsRequesting" OnClientKeyPressing="Combo_HandleKeyPress"
						OnItemsRequested="___TextBoxArmaDev_OnItemsRequested" RenderMode="Classic" TabIndex="3" />
					<Div id="Line1">
					</Div>
					<telerik:RadComboBox id="TextBoxSegundaArma" runat="server" AllowCustomText="False" AutoPostBack="False" CollapseAnimation-Duration="300"
						...
						OnClientItemsRequested="CheckComboItems" OnClientItemsRequesting="Combo_OnClientItemsRequesting" OnClientKeyPressing="Combo_HandleKeyPress"
						OnItemsRequested="___TextBoxSegundaArma_OnItemsRequested" RenderMode="Classic" TabIndex="10" />
					...
					<telerik:RadComboBox id="ComboBox12" runat="server" AllowCustomText="False" AutoPostBack="False" CollapseAnimation-Duration="300"
						...
						OnClientItemsRequested="CheckComboItems" OnClientItemsRequesting="Combo_OnClientItemsRequesting" OnClientKeyPressing="Combo_HandleKeyPress"
						OnItemsRequested="___ComboBox12_OnItemsRequested" RenderMode="Classic" TabIndex="29" />
					<telerik:RadComboBox id="ComboBox13" runat="server" AllowCustomText="False" AutoPostBack="False" CollapseAnimation-Duration="300"
						CollapseAnimation-Type="None" enabled="false" EnableEmbeddedSkins="True" EnableLoadOnDemand="True" EnableVirtualScrolling="True"
						ExpandAnimation-Duration="300" ExpandAnimation-Type="None" LoadingMessage="<%$ Resources: ComboBox13 %>" MarkFirstMatch="true" MaxHeight="100"
						OnClientItemsRequested="CheckComboItems" OnClientItemsRequesting="Combo_OnClientItemsRequesting" OnClientKeyPressing="Combo_HandleKeyPress"
						OnItemsRequested="___ComboBox13_OnItemsRequested" RenderMode="Classic" TabIndex="30" />
				</div>
	...
	<script type="text/javascript">
		...
		function SetFocusFirstField()
		{
			try
			{
				{
					window.focus();
					setTimeout("var $j = jQuery.noConflict();$j('#TextBoxArmeiro').first().focus();", 200);
				}
			}
			catch (e)
			{
		...
		function MUNICAO_QTDE() { return document.getElementById("RadTextBox6").value; }
		function CARREGADOR() { return $find("<%= ComboBox3.ClientID %>").get_value(); }
		...
		function ALGEMA() { return $find("<%= ComboBox7.ClientID %>").get_value(); }
		function ALGEMA_DEV() { return $find("<%= TextBoxAlgema.ClientID %>").get_value(); }
		function COLETE() { return $find("<%= ComboBox9.ClientID %>").get_value(); }
		...
		function MUNICAO_QTDE_SEG() { return document.getElementById("RadTextBox11").value; }
		function MUNICAO_DEV_SEG() { return document.getElementById("TextBoxMunicaoSegArma").value; }
		function RESUMO() { return document.getElementById("RadTextBox13").value; }
		function MUNICAO_DEV() { return document.getElementById("TextBoxMunicao").value; }
		function ArmaDev() { return $find("<%= TextBoxArmaDev.ClientID %>").get_value(); }
		function SEG_ARMA_DEV() { return $find("<%= TextBoxSegundaArma.ClientID %>").get_value(); }
		function ARMA() { return $find("<%= ComboBox12.ClientID %>").get_value(); }
		function SegArma() { return $find("<%= ComboBox13.ClientID %>").get_value(); }
		...
		{
					try { document.getElementById("Label35").innerText = (PageProvider.MainProvider.DataProvider.PageNumber).toString(); }
					catch(e) { document.getElementById("Label35").innerText = ""; }
					try { document.getElementById("Label37").innerText = (PageProvider.MainProvider.DataProvider.PageCount).toString(); }
					catch(e) { document.getElementById("Label37").innerText = ""; }
		}
