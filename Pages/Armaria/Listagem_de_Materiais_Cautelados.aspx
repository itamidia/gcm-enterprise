<%@ page language="C#" validaterequest="false" enableeventvalidation="True" autoeventwireup="true" inherits="gcmenterprise.DataPages.Listagem_de_Materiais_Cautelados, App_Web_g4o5dsry" culture="auto" uiculture="auto" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" lang="<%=gcmenterprise.Utility.CurrentSiteLanguage%>">
<head id="Head1" runat="server">
	<title><asp:Literal runat="server" Text="<%$ Resources: Form1 %>" /></title>
	<link rel="stylesheet" href="../../Styles/Listagem_de_Materiais_Cautelados.css?sv=1.127.2017" type="text/css" media="screen" title="no title" charset="utf-8" />
...
<body onload="InitializeClient();" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	...
	<script type="text/javascript" src="../../JS/Listagem_de_Materiais_Cautelados_USER.js?sv=1.127.2017" language="JavaScript"></script>
		...
		<form id="Form1" runat="server">
			...
			<telerik:RadAjaxPanel id="MainAjaxPanel" runat="server" class="c_MainAjaxPanel" ClientEvents-OnRequestStart="OnRequestStart" ClientEvents-OnResponseEnd="OnResponseEnd" LoadingPanelID="___Form1_AjaxLoading">
				<div id="__MainDiv" class="c_MainDiv" FitToContent="True" MarginToContent="0">
					...
					<div runat="server"  style="position:absolute !important;left:20px;top:128px;width:1287px;height:440px;background-color:#FFFFFF;border-color:#DBD6D6;border-style:Solid;border-width:1px;overflow:auto" AutoExpandToContent="False" AutoExpandToContentMargin="0" EquateRepeaterRegionsWidth="True">
						<asp:Repeater id="Repeater1" runat="server" ClientIDMode="Static">
							<HeaderTemplate>
								<div id="GRepeaterHeader1" AutoExpandWidth="True">
									...
									<telerik:RadLabel id="Label26" runat="server" ClientIDMode="Static" Text="<%$ Resources: Label26 %>" />
									<telerik:RadLabel id="Label50" runat="server" ClientIDMode="Static" Text="<%$ Resources: Label50 %>" />
									<telerik:RadLabel id="Label56" runat="server" ClientIDMode="Static" Text="<%$ Resources: Label56 %>" />
									<telerik:RadLabel id="Label62" runat="server" ClientIDMode="Static" Text="<%$ Resources: Label62 %>" />
									<telerik:RadLabel id="Label74" runat="server" ClientIDMode="Static" Text="<%$ Resources: Label74 %>" />
								</div>
							</HeaderTemplate>
							<ItemTemplate>
								<div id="GRepeaterBody1" AutoExpandToContent="False" AutoExpandToContentMargin="10" AutoExpandWidth="True" runat="server">
									...
									<telerik:RadLabel id="Label51" runat="server" ClientIDMode="Static" />
									<telerik:RadLabel id="Label57" runat="server" ClientIDMode="Static" />
									<telerik:RadLabel id="Label63" runat="server" ClientIDMode="Static" />
									<telerik:RadLabel id="Label75" runat="server" ClientIDMode="Static" />
									...
									<telerik:RadLabel id="Label27" runat="server" ClientIDMode="Static" />
								</div>
							</ItemTemplate>
							<AlternatingItemTemplate>
								<div id="GRepeaterBodyAlt1" AutoExpandToContent="False" AutoExpandToContentMargin="10" AutoExpandWidth="True" runat="server">
									...
									<telerik:RadLabel id="Label52" runat="server" ClientIDMode="Static" />
									<telerik:RadLabel id="Label58" runat="server" ClientIDMode="Static" />
									<telerik:RadLabel id="Label64" runat="server" ClientIDMode="Static" />
									<telerik:RadLabel id="Label76" runat="server" ClientIDMode="Static" />
									...
									<telerik:RadLabel id="Label44" runat="server" ClientIDMode="Static" Text="<%$ Resources: Label44 %>" />
									<telerik:RadLabel id="Label45" runat="server" ClientIDMode="Static" />
									<telerik:RadLabel id="Label46" runat="server" ClientIDMode="Static" />
									<telerik:RadLabel id="Label40" runat="server" ClientIDMode="Static" />
									<telerik:RadLabel id="Label39" runat="server" ClientIDMode="Static" />
									<telerik:RadLabel id="Label38" runat="server" ClientIDMode="Static" Text="<%$ Resources: Label38 %>" />
									...
									<telerik:RadLabel id="Label28" runat="server" ClientIDMode="Static" />
								</div>
							</AlternatingItemTemplate>
						</asp:Repeater>
					</div>
