<%@ page language="C#" validaterequest="false" enableeventvalidation="True" autoeventwireup="true" inherits="gcmenterprise.DataPages.Cadastro_de_Calibre___ARMAS, App_Web_g4o5dsry" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<link rel="stylesheet" href="../../Styles/Cadastro_de_Calibre___ARMAS.css?sv=1.127.2017" type="text/css" media="screen" title="no title" charset="utf-8" />
...
<body onload="InitializeClient(); setTimeout(function() {Form1_onload(this);return false;}, 100);" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	...
	<script type="text/javascript" src="../../JS/Cadastro_de_Calibre___ARMAS_USER.js?sv=1.127.2017" language="JavaScript"></script>
		...
		<form id="Form1" runat="server">
			...
			<telerik:RadAjaxPanel id="MainAjaxPanel" runat="server" class="c_MainAjaxPanel" ClientEvents-OnRequestStart="OnRequestStart" ClientEvents-OnResponseEnd="OnResponseEnd" LoadingPanelID="___Form1_AjaxLoading">
				<div id="__MainDiv" class="c_MainDiv" FitToContent="True" MarginToContent="0">
					...
					<telerik:RadTextBox id="RadTextBox1" runat="server" AutoPostBack="False" enabled="false" EnableSingleInputRendering="True" ForeColor="#FE0101"
					...
					<telerik:RadComboBox id="ComboBox1" runat="server" disable-data-validation-onblur AllowCustomText="False" AutoPostBack="False"
						...
						data-validation-message="ID_GRUPO não pode ser vazio!" EnableEmbeddedSkins="True" EnableLoadOnDemand="True" EnableVirtualScrolling="True"
					...
					<telerik:RadGrid id="Grid1" runat="server" AllowCustomPaging="true" AllowFilteringByColumn="False" AllowPaging="True" AllowSorting="True"
						...
						TableLayout="Fixed">
						<MasterTableView  AllowCustomPaging="true" CommandItemDisplay="Top" DataKeyNames="CAL_ID" EditMode="InPlace" EnableEmbeddedSkins="True" OnItemCreated="Grid1_ItemCreated" OnUpdateCommand="Grid_UpdateCommand" Skin="MetroTouch">
							<Columns>
								...
								<telerik:GridBoundColumn UniqueName="GridColumn1" runat="server" AllowFiltering="True" AllowSorting="true" ConvertEmptyStringToNull="False"
									DataField="CAL_ID" DataFormatString="{0:#########0}" Exportable="True" FilterControlWidth="58" FooterStyle-HorizontalAlign="Right"
								...
								<telerik:GridTemplateColumn UniqueName="GridColumn3" runat="server" AllowFiltering="True" ConvertEmptyStringToNull="False"
									DataField="CAL_ID_MODELO" Exportable="True" FilterControlWidth="242" ForceExtractValue="Always"
									GroupByExpression="CAL_ID_MODELO CAL_ID_MODELO Group By CAL_ID_MODELO" HeaderStyle-Width="277" HeaderText="<%$ Resources: GridColumn3 %>"
									ItemStyle-Width="270" ReadOnly="False" SortExpression="CAL_ID_MODELO" Visible="True">
									<EditItemTemplate>
										<telerik:RadComboBox Skin="MetroTouch" ID="GridColumn3_ComboBox" runat="server" MarkFirstMatch="True" AllowCustomText="False" 
											...
											OnClientBlur="ValidateCombo" data-validation-engine="validate[funcCall[GridColumn3_Validation]]" data-validation-message="ID_GRUPO não pode ser vazio!"
									...
									<ItemTemplate> 
										<asp:Label runat="server" ID="GridColumn3_Label" Text='<%#PageProvider.GetGridComboText("Grid1_GridColumn3", Eval("CAL_ID_MODELO").ToString())%>' Value='<%#Eval("CAL_ID_MODELO").ToString()%>'/>
									</ItemTemplate> 
								...
								<telerik:GridBoundColumn UniqueName="GridColumn2" runat="server" AllowFiltering="True" AllowSorting="true" ConvertEmptyStringToNull="False"
									DataField="CAL_DESCRICAO" Exportable="True" FilterControlWidth="325" ForceExtractValue="Always" HeaderStyle-Width="360"
									HeaderText="<%$ Resources: GridColumn2 %>" ItemStyle-Width="353" MaxLength="50" ReadOnly="False" Visible="True" />
	...
	<script type="text/javascript">
		...
		function CAL_ID() { return document.getElementById("RadTextBox1").value; }
		function CAL_ID_MODELO() { return $find("<%= ComboBox1.ClientID %>").get_value(); }
		function CAL_DESCRICAO() { return document.getElementById("RadTextBox2").value; }
