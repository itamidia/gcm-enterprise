<%@ page language="C#" validaterequest="false" enableeventvalidation="True" autoeventwireup="true" inherits="gcmenterprise.DataPages.Cadastro_de_Grupos___MAT_B_lico, App_Web_g4o5dsry" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<link rel="stylesheet" href="../../Styles/Cadastro_de_Grupos___MAT_B_lico.css?sv=1.127.2017" type="text/css" media="screen" title="no title" charset="utf-8" />
...
<body onload="InitializeClient(); setTimeout(function() {Form1_onload(this);return false;}, 100);" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	...
	<script type="text/javascript" src="../../JS/Cadastro_de_Grupos___MAT_B_lico_USER.js?sv=1.127.2017" language="JavaScript"></script>
			...
			<telerik:RadAjaxPanel id="MainAjaxPanel" runat="server" class="c_MainAjaxPanel" ClientEvents-OnRequestStart="OnRequestStart" ClientEvents-OnResponseEnd="OnResponseEnd" LoadingPanelID="___Form1_AjaxLoading">
				<div id="__MainDiv" class="c_MainDiv" FitToContent="True" MarginToContent="0">
					...
					<telerik:RadGrid id="Grid1" runat="server" AllowCustomPaging="true" AllowFilteringByColumn="False" AllowPaging="True" AllowSorting="True"
						...
						OnUpdateCommand="Grid_UpdateCommand" PageSize="10" RenderMode="Classic" ShowGroupPanel="False" Skin="MetroTouch" TabIndex="3"
						TableLayout="Fixed">
						<MasterTableView  AllowCustomPaging="true" CommandItemDisplay="Top" DataKeyNames="GRUBEL_ID" EditMode="InPlace" EnableEmbeddedSkins="True" OnItemCreated="Grid1_ItemCreated" OnUpdateCommand="Grid_UpdateCommand" Skin="MetroTouch">
							<Columns>
								...
								<telerik:GridBoundColumn UniqueName="GridColumn1" runat="server" AllowFiltering="True" AllowSorting="true" ConvertEmptyStringToNull="False"
									DataField="GRUBEL_ID" DataFormatString="{0:#########0}" Exportable="True" FilterControlWidth="100" FooterStyle-HorizontalAlign="Right"
									ForceExtractValue="Always" HeaderStyle-HorizontalAlign="Right" HeaderStyle-Width="135" HeaderText="<%$ Resources: GridColumn1 %>"
									ItemStyle-HorizontalAlign="Right" ItemStyle-Width="128" MaxLength="10" ReadOnly="False" Visible="True" />
								<telerik:GridBoundColumn UniqueName="GridColumn2" runat="server" AllowFiltering="True" AllowSorting="true" ConvertEmptyStringToNull="False"
									DataField="GRUBEL_DESCRICAO" Exportable="True" FilterControlWidth="527" ForceExtractValue="Always" HeaderStyle-Width="562"
									HeaderText="<%$ Resources: GridColumn2 %>" ItemStyle-Width="555" MaxLength="50" ReadOnly="False" Visible="True" />
	...
	<script type="text/javascript">
		...
		function GRUBEL_ID() { return document.getElementById("RadTextBox1").value; }
		function GRUBEL_DESCRICAO() { return document.getElementById("RadTextBox2").value; }
