<%@ page language="C#" validaterequest="false" enableeventvalidation="True" autoeventwireup="true" inherits="gcmenterprise.DataPages.Cadastro_de_Folgas_Ferias, App_Web_imjh5exu" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<link rel="stylesheet" href="../../Styles/Cadastro_de_Folgas_Ferias.css?sv=1.127.2017" type="text/css" media="screen" title="no title" charset="utf-8" />
...
<body onload="InitializeClient(); setTimeout(function() {Form1_onload(this);return false;}, 100);" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	...
	<script type="text/javascript" src="../../JS/Cadastro_de_Folgas_Ferias_USER.js?sv=1.127.2017" language="JavaScript"></script>
	...
	<script language="JavaScript" type="text/javascript">
		...
		function dpTermino_Validation(field, rules, i, options) {
			if (!(validateCall(field, "required", options))) {
				return field.attr('data-validation-message');
			}
		}
				...
				<div id="__MainDiv" class="c_MainDiv" FitToContent="True" MarginToContent="0">
					...
					<div id="Div2" runat="server" AutoExpandToContent="False" AutoExpandToContentMargin="10">
						...
						<asp:Button id="Button12" runat="server" CommandName="Button12" OnClick="___Button12_OnClick" OnClientClick="this.disabled = true;"
							TabIndex="18" ToolTip="Imprimi o Aviso de Licença Prêmio" />
					</div>
					...
					<telerik:RadDatePicker id="dpInicio" runat="server" ClientEvents-OnDateSelected="setDatePickerFocus" DateInput-DateFormat="dd/MM/yy"
					...
					<telerik:RadDatePicker id="dpTermino" runat="server" Calendar-ClientEvents-OnDateClick="HideDatePickerValidation"
						...
						ReadOnly="False" RenderMode="Classic" ShowAnimation-Duration="300" ShowAnimation-Type="Fade" TabIndex="7" Width="212px">
						<DateInput data-validation-engine="validate[funcCall[dpTermino_Validation]]" data-validation-message="DATA_TERMINO não pode ser vazio!" />
					</telerik:RadDatePicker>
					...
					<telerik:RadComboBox id="ComboBox1" runat="server" disable-data-validation-onblur AllowCustomText="False" AutoPostBack="False"
						...
						OnClientKeyPressing="Combo_HandleKeyPress" OnItemsRequested="___ComboBox1_OnItemsRequested" RenderMode="Classic" TabIndex="4" />
					...
					<telerik:RadComboBox id="ComboBox2" runat="server" disable-data-validation-onblur AllowCustomText="False" AutoPostBack="False"
						...
						OnClientKeyPressing="Combo_HandleKeyPress" OnItemsRequested="___ComboBox2_OnItemsRequested" RenderMode="Classic" TabIndex="2" />
					<telerik:RadLabel id="Label18" runat="server" Text="<%$ Resources: Label18 %>" />
					<telerik:RadTextBox id="txtDias" runat="server" AutoPostBack="False" EnableSingleInputRendering="True" ForeColor="#000000" MaxLength="10"
						onkeydown="onTextChanged" ReadOnly="False" RenderMode="Classic" TabIndex="6" TextMode="SingleLine" WrapperCssClass="c_txtDias_wrapper" />
	...
	<script type="text/javascript">
		...
		function FERIAR_ID() { return document.getElementById("RadTextBox1").value; }
		function FERIAS_DESCRICAO() { return document.getElementById("RadTextBox3").value; }
		function FERIAS_DATA_INICIO() { return document.getElementById("dpInicio").value; }
		function FERIAS_DATA_TERMINO() { return document.getElementById("dpTermino").value; }
		function FERIAS_TIPO_FOLGA() { return $find("<%= ComboBox1.ClientID %>").get_value(); }
		function FERIAS_ID_GCM() { return $find("<%= ComboBox2.ClientID %>").get_value(); }
		function FERIAS_DIAS() { return document.getElementById("txtDias").value; }
		...
		function LoadEditAuto() {
				...
				$j("#txtDias").bind("keydown", InitiateEditAuto);
				$j("#ComboBox1").bind("change", InitiateEditAuto);
				$j("#ComboBox2").bind("change", InitiateEditAuto);
				$j("#dpInicio").bind("change", InitiateEditAuto);
				$j("#dpInicio_dateInput").bind("keydown", InitiateEditAuto);
				$j("#dpTermino").bind("change", InitiateEditAuto);
				$j("#dpTermino_dateInput").bind("keydown", InitiateEditAuto);
		}
