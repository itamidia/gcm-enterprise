<%@ page language="C#" validaterequest="false" enableeventvalidation="True" autoeventwireup="true" inherits="gcmenterprise.DataPages.Consultas_de_Nota_de_Puni__es, App_Web_imjh5exu" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<link rel="stylesheet" href="../../Styles/Consultas_de_Nota_de_Puni__es.css?sv=1.127.2017" type="text/css" media="screen" title="no title" charset="utf-8" />
...
<body onload="InitializeClient(); setTimeout(function() {Form1_onload(this);return false;}, 100);" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	...
	<script type="text/javascript" src="../../JS/Consultas_de_Nota_de_Puni__es_USER.js?sv=1.127.2017" language="JavaScript"></script>
		...
		<form id="Form1" runat="server">
			...
			<telerik:RadAjaxPanel id="MainAjaxPanel" runat="server" class="c_MainAjaxPanel" ClientEvents-OnRequestStart="OnRequestStart" ClientEvents-OnResponseEnd="OnResponseEnd" LoadingPanelID="___Form1_AjaxLoading">
				<div id="__MainDiv" class="c_MainDiv" FitToContent="True" MarginToContent="0">
					...
					<div runat="server"  style="position:absolute !important;left:20px;top:128px;width:1851px;height:500px;background-color:#FFFFFF;border-color:#DBD6D6;border-style:Solid;border-width:1px;overflow:auto" AutoExpandToContent="False" AutoExpandToContentMargin="0" EquateRepeaterRegionsWidth="True">
						<asp:Repeater id="Repeater1" runat="server" ClientIDMode="Static">
							<HeaderTemplate>
								<div id="GRepeaterHeader1" AutoExpandWidth="True">
									...
									<telerik:RadLabel id="Label14" runat="server" ClientIDMode="Static" Text="<%$ Resources: Label14 %>" />
							...
							<ItemTemplate>
								<div id="GRepeaterBody1" AutoExpandToContent="False" AutoExpandToContentMargin="10" AutoExpandWidth="True" runat="server">
									...
									<telerik:RadLabel id="Label15" runat="server" ClientIDMode="Static" />
									...
									<gas:GMultiMedia id="GMultiMedia1" runat="server" BorderWidth="1" CanDownloadFile="True" CanUploadFile="false" enabled="true"
										EncryptedFile="False" Height="25px" Left="1617px" MaxFileSize="0" Path="~/Pages/FILE/" SaveAsFile="True"
										SessionHandlerObjectName="NOTA_DOC_FOTO24090" ShowDownloadLink="True" ShowImage="False" TabIndex="6" Top="-1px" Visible="true" Width="190px"
										/>
								</div>
							</ItemTemplate>
							<AlternatingItemTemplate>
								<div id="GRepeaterBodyAlt1" AutoExpandToContent="False" AutoExpandToContentMargin="10" AutoExpandWidth="True" runat="server">
									...
									<telerik:RadLabel id="Label16" runat="server" ClientIDMode="Static" />
									...
									<gas:GMultiMedia id="GMultiMedia2" runat="server" BorderWidth="1" CanDownloadFile="True" CanUploadFile="false" enabled="true"
										EncryptedFile="False" Height="25px" Left="1618px" MaxFileSize="0" Path="~/Pages/FILE/" SaveAsFile="True"
										SessionHandlerObjectName="NOTA_DOC_FOTO24090" ShowDownloadLink="True" ShowImage="False" TabIndex="7" Top="-1px" Visible="true" Width="190px"
										/>
								</div>
							</AlternatingItemTemplate>
						</asp:Repeater>
