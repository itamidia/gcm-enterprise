<%@ page language="C#" autoeventwireup="true" enableeventvalidation="True" inherits="gcmenterprise.ConfigDB, App_Web_o3n4gjlu" culture="auto" uiculture="auto" %>
...
<head runat="server">
	...
	<link rel="stylesheet" href="../Styles/ConfigDB.css?sv=1.127.2017" type="text/css" media="screen" title="no title" charset="utf-8" />
</head>
<script type="text/javascript" src="../JS/ConfigDB_USER.js?sv=1.127.2017" language="JavaScript"></script>
			...
			<div id="__MainDiv" class="c_MainDiv" FitToContent="True" MarginToContent="0">
				<div id="Div1" runat="server" AutoExpandToContent="False" AutoExpandToContentMargin="10">
					...
					<telerik:RadAjaxPanel id="ajxAjaxPanel" runat="server" LoadingPanelID="___ajxAjaxPanel_AjaxLoading">
						<telerik:RadTextBox id="txtServer" runat="server" AutoPostBack="False" EnableSingleInputRendering="True" ForeColor="#000000" MaxLength="0"
							ReadOnly="False" RenderMode="Classic" TabIndex="1" TextMode="SingleLine" WrapperCssClass="c_txtServer_wrapper" />
						<telerik:RadTextBox id="txtDataBase" runat="server" AutoPostBack="False" EnableSingleInputRendering="True" ForeColor="#000000" MaxLength="0"
							ReadOnly="False" RenderMode="Classic" TabIndex="2" TextMode="SingleLine" WrapperCssClass="c_txtDataBase_wrapper" />
						...
						<telerik:RadTextBox id="txtUser" runat="server" AutoPostBack="False" EnableSingleInputRendering="True" ForeColor="#000000" MaxLength="0"
							ReadOnly="False" RenderMode="Classic" TabIndex="4" TextMode="SingleLine" WrapperCssClass="c_txtUser_wrapper" />
						<telerik:RadTextBox id="txtPassword" runat="server" AutoPostBack="False" EnableSingleInputRendering="True" ForeColor="#000000" MaxLength="0"
							ReadOnly="False" RenderMode="Classic" TabIndex="5" TextMode="Password" WrapperCssClass="c_txtPassword_wrapper" />
						...
						<telerik:RadTextBox id="txtProvider" runat="server" AutoPostBack="False" EnableSingleInputRendering="True" ForeColor="#000000" MaxLength="0"
							ReadOnly="False" RenderMode="Classic" TabIndex="7" TextMode="SingleLine" WrapperCssClass="c_txtProvider_wrapper" />
