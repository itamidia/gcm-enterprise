<%@ page language="C#" validaterequest="false" enableeventvalidation="True" autoeventwireup="true" inherits="gcmenterprise.DataPages.Cadastro_de_Fornecedor, App_Web_wz1zfzss" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<link rel="stylesheet" href="../../Styles/Cadastro_de_Fornecedor.css?sv=1.127.2017" type="text/css" media="screen" title="no title" charset="utf-8" />
...
<body onload="InitializeClient(); setTimeout(function() {Form1_onload_1(this);return false;}, 100);" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	...
	<script type="text/javascript" src="../../JS/Cadastro_de_Fornecedor_USER.js?sv=1.127.2017" language="JavaScript"></script>
		...
		<form id="Form1" runat="server">
			...
			<telerik:RadAjaxPanel id="MainAjaxPanel" runat="server" class="c_MainAjaxPanel" ClientEvents-OnRequestStart="OnRequestStart" ClientEvents-OnResponseEnd="OnResponseEnd" LoadingPanelID="___Form1_AjaxLoading">
				<div id="__MainDiv" class="c_MainDiv" FitToContent="True" MarginToContent="0">
					...
					<div style="position:absolute !important;left:30px;top:57px;width:1010px;height:462px">
						...
						<telerik:RadMultiPage runat="server" ID="TabControl1MultiPage" BorderColor="#000000" BorderWidth="1" BorderStyle="Solid" Width="100%" Height="436px" SelectedIndex="0">
							<telerik:RadPageView id="TabPage1" runat="server" BackColor="#FFFFFF">
								<telerik:RadTextBox id="RadTextBox1" runat="server" AutoPostBack="False" enabled="false" EnableSingleInputRendering="True"
									ForeColor="#FE0404" MaxLength="10" onkeydown="onTextChanged" ReadOnly="True" RenderMode="Classic" TextMode="SingleLine"
								...
								<telerik:RadTextBox id="RadTextBox12" runat="server" AutoPostBack="False" EnableSingleInputRendering="True" ForeColor="#000000"
									MaxLength="25" onkeydown="onTextChanged" ReadOnly="False" RenderMode="Classic" TabIndex="13" TextMode="SingleLine"
								...
								<telerik:RadTextBox id="RadTextBox13" runat="server" AutoPostBack="False" EnableSingleInputRendering="True" ForeColor="#000000"
									MaxLength="100" onkeydown="onTextChanged" ReadOnly="False" RenderMode="Classic" TabIndex="14" TextMode="SingleLine"
								...
								<telerik:RadTextBox id="RadTextBox14" runat="server" AutoPostBack="False" EnableSingleInputRendering="True" ForeColor="#000000"
									MaxLength="100" onkeydown="onTextChanged" ReadOnly="False" RenderMode="Classic" TabIndex="15" TextMode="SingleLine"
								...
								<asp:Button id="Button1" runat="server" CommandName="Button1" OnClick="___Button1_OnClick" TabIndex="17" Text="<%$ Resources: Button1 %>" />
	...
	<script type="text/javascript">
		...
		function FOR_ID() { return document.getElementById("RadTextBox1").value; }
		function FOR_RAZAO_SOCIAL() { return document.getElementById("RadTextBox2").value; }
		function FOR_FANTASIA() { return document.getElementById("RadTextBox3").value; }
		function FOR_CNPJ() { return document.getElementById("RadTextBox4").value; }
		function FOR_INS_ESTADUAL() { return document.getElementById("RadTextBox5").value; }
		function FOR_INS_MUNICIPAL() { return document.getElementById("RadTextBox6").value; }
		function FOR_TELEFONE() { return document.getElementById("RadTextBox11").value; }
		function FOR_CONTATO() { return document.getElementById("RadTextBox12").value; }
		function FOR_EMAIL() { return document.getElementById("RadTextBox13").value; }
		function FOR_SITE() { return document.getElementById("RadTextBox14").value; }
		function FOR_CEP() { return document.getElementById("TxtCEP").value; }
		function FOR_UF() { return $find("<%= TxtUF.ClientID %>").get_value(); }
		function FOR_BAIRRO() { return $find("<%= TxtBairro.ClientID %>").get_value(); }
		function FOR_CIDADE() { return $find("<%= TxtCidade.ClientID %>").get_value(); }
		function FOR_ENDERECO() { return $find("<%= TxtLogradouro.ClientID %>").get_value(); }
		function FOR_TIPO_LOGRADOURO() { return $find("<%= TxtTipoLogradouro.ClientID %>").get_value(); }
