<%@ page language="C#" validaterequest="false" enableeventvalidation="True" autoeventwireup="true" inherits="gcmenterprise.DataPages.Controle_da_Corregedoria, App_Web_o3n4gjlu" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<link rel="stylesheet" href="../Styles/Controle_da_Corregedoria.css?sv=1.127.2017" type="text/css" media="screen" title="no title" charset="utf-8" />
...
<body onload="InitializeClient();" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	...
	<script type="text/javascript" src="../JS/Controle_da_Corregedoria_USER.js?sv=1.127.2017" language="JavaScript"></script>
			...
			<telerik:RadAjaxPanel id="MainAjaxPanel" runat="server" class="c_MainAjaxPanel" ClientEvents-OnRequestStart="OnRequestStart" ClientEvents-OnResponseEnd="OnResponseEnd" LoadingPanelID="___Form1_AjaxLoading">
				<div id="__MainDiv" class="c_MainDiv" FitToContent="True" MarginToContent="0">
						...
						<MasterTableView  AllowCustomPaging="true" CommandItemDisplay="Top" DataKeyNames="GCM_ID,GCM_RE_MATRICULA,GCM_RG,GCM_CPF" EditMode="InPlace" OnItemCreated="Grid1_ItemCreated" OnUpdateCommand="Grid_UpdateCommand">
							<Columns>
								<telerik:GridBoundColumn UniqueName="GridColumn1" runat="server" AllowFiltering="True" AllowSorting="true" ConvertEmptyStringToNull="False"
									DataField="GCM_ID" DataFormatString="{0:#########0}" Exportable="True" FilterControlWidth="32" FooterStyle-HorizontalAlign="Right"
								...
								<telerik:GridBoundColumn UniqueName="GridColumn2" runat="server" AllowFiltering="True" AllowSorting="true" ConvertEmptyStringToNull="False"
									DataField="GCM_NOME" Exportable="True" FilterControlWidth="159" ForceExtractValue="Always" HeaderStyle-Width="194"
									HeaderText="<%$ Resources: GridColumn2 %>" ItemStyle-Width="187" MaxLength="50" ReadOnly="False" Visible="True" />
								<telerik:GridBoundColumn UniqueName="GridColumn3" runat="server" AllowFiltering="True" AllowSorting="true" ConvertEmptyStringToNull="False"
									DataField="GCM_RE_MATRICULA" DataFormatString="{0:###################0}" Exportable="True" FilterControlWidth="61"
									FooterStyle-HorizontalAlign="Right" ForceExtractValue="Always" HeaderStyle-HorizontalAlign="Right" HeaderStyle-Width="96"
									HeaderText="<%$ Resources: GridColumn3 %>" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="89" MaxLength="20" ReadOnly="False"
									Visible="True" />
								<telerik:GridBoundColumn UniqueName="GridColumn4" runat="server" AllowFiltering="True" AllowSorting="true" ConvertEmptyStringToNull="False"
									DataField="GCM_CPF" Exportable="True" FilterControlWidth="69" ForceExtractValue="Always" HeaderStyle-Width="104"
									HeaderText="<%$ Resources: GridColumn4 %>" ItemStyle-Width="97" MaxLength="14" ReadOnly="False" Visible="True" />
								<telerik:GridBoundColumn UniqueName="GridColumn5" runat="server" AllowFiltering="True" AllowSorting="true" ConvertEmptyStringToNull="False"
									DataField="GCM_FUNCAO" Exportable="True" FilterControlWidth="109" ForceExtractValue="Always" HeaderStyle-Width="144"
									HeaderText="<%$ Resources: GridColumn5 %>" ItemStyle-Width="137" MaxLength="20" ReadOnly="False" Visible="True" />
								<telerik:GridBoundColumn UniqueName="GridColumn6" runat="server" AllowFiltering="True" AllowSorting="true" ConvertEmptyStringToNull="False"
									DataField="GCM_GUERRA" Exportable="True" FilterControlWidth="58" ForceExtractValue="Always" HeaderStyle-Width="93"
								...
								<telerik:GridBoundColumn UniqueName="GridColumn7" runat="server" AllowFiltering="True" AllowSorting="true" ConvertEmptyStringToNull="False"
									DataField="GCM_TELEFONE" DataFormatString="{0:##################0}" Exportable="True" FilterControlWidth="58"
									FooterStyle-HorizontalAlign="Right" ForceExtractValue="Always" HeaderStyle-HorizontalAlign="Right" HeaderStyle-Width="93"
									HeaderText="<%$ Resources: GridColumn7 %>" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="86" MaxLength="14" ReadOnly="False"
									Visible="True" />
								<telerik:GridBoundColumn UniqueName="GridColumn8" runat="server" AllowFiltering="True" AllowSorting="true" ConvertEmptyStringToNull="False"
									DataField="GCM_CELULAR" DataFormatString="{0:##################0}" Exportable="True" FilterControlWidth="58"
									FooterStyle-HorizontalAlign="Right" ForceExtractValue="Always" HeaderStyle-HorizontalAlign="Right" HeaderStyle-Width="93"
									HeaderText="<%$ Resources: GridColumn8 %>" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="86" MaxLength="15" ReadOnly="False"
									Visible="True" />
								<telerik:GridBoundColumn UniqueName="GridColumn9" runat="server" AllowFiltering="True" AllowSorting="true" ConvertEmptyStringToNull="False"
									DataField="GCM_COMPORTAMENTO" Exportable="True" FilterControlWidth="58" ForceExtractValue="Always" HeaderStyle-Width="93"
								...
								<telerik:GridTemplateColumn UniqueName="GridColumn10" runat="server" AllowFiltering="True" ConvertEmptyStringToNull="False"
									...
									GroupByExpression="GCM_STATUS GCM_STATUS Group By GCM_STATUS" HeaderStyle-Width="93" HeaderText="<%$ Resources: GridColumn10 %>"
									...
									<EditItemTemplate>
										<telerik:RadComboBox ID="GridColumn10_ComboBox" runat="server" MarkFirstMatch="True" AllowCustomText="False" 
											...
											OnClientBlur="ValidateCombo" data-validation-engine="validate[funcCall[GridColumn10_Validation]]" data-validation-message="STATUS não pode ser vazio!"
									...
									<ItemTemplate> 
										<asp:Label runat="server" ID="GridColumn10_Label" Text='<%#PageProvider.GetGridComboText("Grid1_GridColumn10", Eval("GCM_STATUS").ToString())%>' Value='<%#Eval("GCM_STATUS").ToString()%>'/>
									</ItemTemplate> 
									<FilterTemplate>
										<telerik:RadComboBox ID="GridColumn10_ComboBox_Filter" runat="server" AllowCustomText="False" TabIndex="1"
					...
					<div id="Div2" runat="server" AutoExpandToContent="False" AutoExpandToContentMargin="10">
						...
						<asp:Button id="Button18" runat="server" CommandName="Button18" OnClick="___Button18_OnClick" TabIndex="18" Text="<%$ Resources: Button18 %>" />
						<asp:Button id="Button19" runat="server" CommandName="Button19" OnClick="___Button19_OnClick" TabIndex="19" Text="<%$ Resources: Button19 %>" />
					</div>
				</div>
